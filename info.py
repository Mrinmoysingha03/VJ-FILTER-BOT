...
PICS = (environ.get('PICS', 'https://envs.sh/W79.jpg
')).split() #SAMPLE PIC
NOR_IMG = environ.get("NOR_IMG", "https://graph.org/file/b69af2db776e4e85d21ec.jpg")
MELCOW_VID = environ.get("MELCOW_VID", "https://t.me/+KPPR--b6DzIzYTZl")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002176711764').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002176566035') # give your force subscribe channel id here else leave it blank
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://sumitrasinghasarkar:yPfIZrAA9GUh3aek@cluster0.oq4jm.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
VERIFY_TUTORIAL = environ.get('VERIFY_TUTORIAL', 'https://t.me/+KPPR--b6DzIzYTZl')
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "particular-caressa-moviesending-ad975e69.koyeb.app/")
